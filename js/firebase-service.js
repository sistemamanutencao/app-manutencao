...
function normalizarChamadoFirebase(documento) {
  ...
  return {
    ...
    andar: dados.andar || "",
    setor: dados.setor || dados.setorSolicitante || "Não informado",
    setorSolicitante: dados.setorSolicitante || dados.solicitanteNome || dados.setor || "Não informado",
    ...
    solicitanteNome: dados.solicitanteNome || dados.setorSolicitante || dados.criadoPorNome || "Não informado",
